"""
Django settings for meubaz project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'catalog.context_processors.latest_products',
            ],
        },
    },
]

WSGI_APPLICATION = 'meubaz.wsgi.application'
...
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'admin@meubaz.com.br'
